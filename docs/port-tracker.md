...
| 4 | Map Home (+ variants 1a–1e) | `features/map_home` | In progress | codex/home-migration | Home map, sheet, county peek, v1-style For You section, and Supabase-backed visits/counties/recommendations are ported. Detection overlays, variants, quests, friends, and offline cache still pending |
